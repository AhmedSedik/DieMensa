...
public class Adapter2 extends ArrayAdapter<Dish> {



    public Adapter2(@NonNull Context context, List<Dish> dishes) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listDishesView==null){
            listDishesView = LayoutInflater.from(getContext()).inflate(R.layout.list_item_2,
                    parent,false);
