...
public class Adapter3 extends ArrayAdapter<Dish> {



    public Adapter3(@NonNull Context context, List<Dish> dishes) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listDishesView==null){
            listDishesView = LayoutInflater.from(getContext()).inflate(R.layout.list_item_3,
                    parent,false);
